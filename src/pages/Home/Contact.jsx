      ...
      <div className="col-10 offset-1 offset-md-0 col-md-5">
        <Form>
          <FormGroup row>
            ...
            <Input className="bg-soft-grey" type="text" name="name" id="userName" placeholder="Full name" style={{boxShadow:"none"}} />
          </FormGroup>

          <FormGroup row>
            <Label for="userEmail" hidden>Email</Label>
            <Input className="bg-soft-grey" type="email" name="email" id="userEmail" placeholder="E-mail address" style={{boxShadow:"none"}} />
          </FormGroup>

          <FormGroup row>
            <Label for="userMessage" hidden>Message</Label>
            <Input className="bg-soft-grey" type="textarea" name="message" id="userMessage" placeholder="Write your message" rows={6} style={{boxShadow:"none"}} />
          </FormGroup>
