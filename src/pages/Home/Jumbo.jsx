        ...
        <Row>
          <Col lg="6" className="d-flex">
            <div className="d-flex flex-column m-auto">
              <h1 className="mt-5 text-main-blue">Laborum aute culpa occaecat culpa voluptate sint ullamco reprehenderit laboris.</h1>
          ...
          <Col lg="6" className="d-flex">
            <img src="assets/HomePage/banner.png" alt="Banner" width="100%" className="d-flex m-auto" />
          </Col>
        </Row>
      </Container>
    </Jumbotron>
